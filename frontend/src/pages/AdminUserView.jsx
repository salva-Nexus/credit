...
const SpinnerDark = () => (
  <div
    style={{
      width: 13,
      height: 13,
      border: "2px solid rgba(26,60,94,0.2)",
...
export default function AdminUserView() {
  ...
  const handleSaveDate = async (txId) => {
    setSavingDate(true);
    try {
      await API.put(`/api/admin/transaction/${txId}/edit`, {
        ...
        {confirmDeleteTx && (
          ...
          >
            ...
            >
              ...
              >
                This will permanently remove this transaction from the user's
              ...
              <div style={{ display: "flex", gap: 10 }}>
                ...
                <button
                  onClick={() => handleDeleteTx(confirmDeleteTx)}
                  disabled={deletingTx}
                  style={{
                    flex: 1,
                    padding: "11px",
                    ...
                    fontSize: 14,
                    fontWeight: 700,
                    cursor: deletingTx ? "not-allowed" : "pointer",
                    transition: "background 0.15s",
                    opacity: deletingTx ? 0.8 : 1,
                    display: "flex",
                    alignItems: "center",
                    justifyContent: "center",
                    gap: 8,
  ...
  const pendingTxs = (user.transactions || []).filter(
    (t) => t.status === "pending",
  );
    ...
    <div style={{ minHeight: "100vh", background: "#f8fafc" }}>
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          ...
          <div>
            ...
            >
              {user.email} · {user.accountType} account
            </p>
          </div>
        </div>
        <div
          ...
          <span
            style={{
              ...
              background: user.isVerified
                ? "rgba(34,197,94,0.2)"
                : "rgba(239,68,68,0.2)",
              color: user.isVerified ? "#86efac" : "#fca5a5",
              fontSize: 12,
              fontWeight: 600,
      ...
      >
        {[
          ...
          },
          {
            ...
            value: `$${(user.savingsBalance || 0).toLocaleString("en-US", { minimumFractionDigits: 2 })}`,
            color: "#16a34a",
          },
          {
            label: "Transactions",
          ...
          },
          {
            ...
            color: pendingTxs.length > 0 ? "#d97706" : "#374151",
          },
          ...
          <div key={label} style={{ whiteSpace: "nowrap" }}>
            ...
            <p
              style={{
                ...
                fontWeight: 800,
                color,
                fontFamily: label === "Account #" ? "monospace" : "inherit",
              }}
            >
              {value}
            </p>
      ...
      >
        {[
          ...
          {
            id: "transactions",
            label: `Transactions (${(user.transactions || []).length})`,
          },
          ...
          <button
            ...
            style={{
              ...
              background: "none",
              border: "none",
              borderBottom: `2.5px solid ${tab === t.id ? "#1a3c5e" : "transparent"}`,
              fontSize: 13,
              fontWeight: 600,
              color: tab === t.id ? "#1a3c5e" : "#64748b",
              cursor: "pointer",
              whiteSpace: "nowrap",
      ...
      <div style={{ padding: "28px 32px", maxWidth: 1000 }}>
        ...
        {tab === "balance" && (
          <div style={{ maxWidth: 420 }}>
            ...
            >
              <div>
                ...
                <input
                  type="number"
                  step="0.01"
                  value={balanceEdit.checking}
                  onChange={(e) =>
                    setBalanceEdit((b) => ({ ...b, checking: e.target.value }))
                  }
                  style={inp}
                />
              </div>
              <div>
                ...
                <input
                  type="number"
                  step="0.01"
                  value={balanceEdit.savings}
                  onChange={(e) =>
                    setBalanceEdit((b) => ({ ...b, savings: e.target.value }))
                  }
                  style={inp}
                />
              </div>
              <button
                ...
                style={{
                  ...
                  fontSize: 14,
                  border: "none",
                  cursor: savingBalance ? "not-allowed" : "pointer",
                  opacity: savingBalance ? 0.8 : 1,
                  transition: "opacity 0.15s",
                }}
              >
                {savingBalance ? (
            ...
            >
              ⚠️ This directly modifies the balance. Use "Add Transaction" to
            ...
            >
              {[
                ...
                <div
                  key={key}
                  style={{
                    gridColumn: ["address", "email"].includes(key)
                      ? "1 / -1"
                      : "auto",
                  }}
                >
              ...
              <div>
                ...
                <select
                  value={profileEdit.accountType || "checking"}
                  onChange={(e) =>
                    setProfileEdit((p) => ({
                      ...p,
              ...
              <div>
                ...
                <select
                  value={profileEdit.isVerified ? "true" : "false"}
                  onChange={(e) =>
                    setProfileEdit((p) => ({
                      ...p,
        ...
        {tab === "transactions" && (
          <div>
            ...
            >
              All Transactions ({(user.transactions || []).length})
            </h2>
            <div
              style={{
                background: "white",
                    ...
                    (user.transactions || [])
                      ...
                      .map((tx) => (
                        ...
                        >
                          ...
                          <td style={tdS}>
                            <button
                              onClick={() => setConfirmDeleteTx(tx._id)}
                              style={{
                                display: "flex",
                                alignItems: "center",
                                gap: 4,
            ...
            {pendingTxs.length === 0 ? (
              ...
              >
                ...
                >
                  <thead>
                    <tr>
                      {["Type", "Amount", "Details", "Date", "Actions"].map(
                        (h) => (
                          <th key={h} style={thS}>
                            {h}
                          </th>
                    ...
                    {pendingTxs.map((tx) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <td style={{ ...tdS, fontWeight: 700, fontSize: 14 }}>
                            $
                              ...
                              <button
                                ...
                                style={{
                                  ...
                                  cursor: isAnyLoading
                                    ...
                                    : "pointer",
                                  opacity:
                                    isAnyLoading && !isLoadingApprove ? 0.5 : 1,
                                  minWidth: 90,
                                  justifyContent: "center",
                                }}
                              >
                              ...
                              <button
                                ...
                                style={{
                                  ...
                                  cursor: isAnyLoading
                                    ...
                                    : "pointer",
                                  opacity:
                                    isAnyLoading && !isLoadingReject ? 0.5 : 1,
                                  minWidth: 80,
                                  justifyContent: "center",
                                }}
                              >
            ...
            >
              <div>
                ...
                <select
                  value={manualTx.type}
                  onChange={(e) =>
                    setManualTx((t) => ({ ...t, type: e.target.value }))
                  }
                  style={{ ...inp, cursor: "pointer" }}
                >
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setManualTx((t) => ({ ...t, amount: e.target.value }))
                  }
                  style={inp}
                />
              </div>
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    setManualTx((t) => ({ ...t, status: e.target.value }))
                  }
                  style={{ ...inp, cursor: "pointer" }}
                >
              ...
              <div>
                ...
                <input
                  placeholder="e.g. Account credit, Wire fee, Adjustment"
                  value={manualTx.memo}
                  onChange={(e) =>
                    setManualTx((t) => ({ ...t, memo: e.target.value }))
                  }
                  style={inp}
                />
              </div>
              <button
                ...
                style={{
                  ...
                  opacity: addingTx ? 0.8 : 1,
                  transition: "opacity 0.15s",
                }}
              >
                {addingTx ? (
                  <>
                    <Spinner /> Adding transaction…
                  </>
                ) : (
                  <>
          ...
          >
            ...
            <div style={{ display: "flex", gap: 10 }}>
              ...
              <button
                ...
                onMouseEnter={(e) => {
                  if (!deletingTx) e.currentTarget.style.background = "#b91c1c";
                }}
                onMouseLeave={(e) =>
                  (e.currentTarget.style.background = "#dc2626")
                }
